...
import { FeedController, ForumsController, SavedForumsController } from './forums.controller.js';
...
@Module({
  ...
  controllers: [FeedController, ForumsController, SavedForumsController],
  providers: [
    ForumsRepository,
    ForumsService,
    RichTextService,
